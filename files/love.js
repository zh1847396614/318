  ...
  $("#showliuyan").click(function(event) {
        $("#liuyan").fadeToggle(400);
  });
...
function()
{
    ...
    var ref = new Wilddog("https://zhangxiaohuidata.wilddogio.com/treeData/");


  if($("#name").val().trim()==""||$("#context").val().trim()=="")
  {
...
var  txt= $("#context").val().trim();


 for(var inum=0;inum<window.keyValue.length;inum++)
 {
      if(txt==window.liuyanTxt[inum])
      {
 ...
 var childref = ref.push({"name":$("#name").val(),"date":getNowFormatDate(),"context":txt});
 alert("小树又长嫩绿的叶子了需要刷新网页才能显示")
$("#show").click();
    });
...
function()
{
    ...
    var ref = new Wilddog("https://zhangxiaohuidata.wilddogio.com/liuyan/");

       if($("#mmm").val()!='318')
        {alert("对不起,你不是VIP会员,无法添加。")
 return;
}

  if($("#liuyantxt").val().trim()==""||$("#shuName").val().trim()=="")
  {
...
var  txt= $("#liuyantxt").val().trim();


 for(var inum=0;inum<window.liuyanTxt.length;inum++)
 {
      if(txt==window.liuyanTxt[inum])
      {
 ...
 var childref = ref.push({"name":$("#shuName").val(),"date":getNowFormatDate(),"context":txt});
 alert("添加成功 留言随机显示")
$("#showliuyan").click();
    });
...
for(var js2 in data)
 {  
   ...
   window.keyValue[ window.keyValue.length]=data[js2]["context"];
 }  
...
ref.on("value", function(snapshot) 
{
 ...
 window.keyValuess=snapshot.val();
jisuan(window.keyValuess);
...
var ref2 = new Wilddog("https://zhangxiaohuidata.wilddogio.com/liuyan/");
...
ref2.on("value", function(snapshot) 
{
 ...
 var  ref2Key=new  Array();
  window.liuyanTxt=new  Array();
  var data=snapshot.val() ;
for (var js in data ) 
{
 ref2Key[ref2Key.length]= js;
 //防止重复提交
 liuyanTxt[liuyanTxt.length]=data[js]["context"];
};
var ref2Num= getRandom(ref2Key.length-1);
 for(var i=0;i<ref2Key.length;i++)
 {

    if(i==ref2Num)
    {
       $("#wenCotext").text(data[ref2Key[i]]["context"])
        $("#shuming").html('<span class="space"></span> --  '+data[ref2Key[i]]["name"])
    }
 ...
 (function(){
        ...
        var moveAnimate = eval(Jscex.compile("async", function () {
            //*****复制画布 
            tree.snapshot("p1", 150, 0, 810, 680);
            while (tree.move("p1", 400, 0)) {
                foot.draw();
                $await(Jscex.Async.sleep(10));
            }
            foot.draw();
            tree.snapshot("p2", 500, 0, 810, 680);
        ...
        var textAnimate = eval(Jscex.compile("async", function () {
            ...
            together.setFullYear(2017, 4, 10);
            together.setHours(0);
